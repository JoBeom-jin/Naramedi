<div id="hopital-list">	
	...
	<div class="btn-area-left">
		<a href="<?=$menu_url?>/insertMember" class="btn btn-primary" onclick="window.open(this.href,'inertMember','width=650,height=820'); return false;" >병원등록</a>
	</div>
	...
	<table class="table table-list " summary="가입된 회원 정보를 목록형태로 보여줍니다." >
		...
		<tbody>
			...
			<tr class="tcenter-all">
				...
				<td>
					<a href="<?=$menu_url?>/modify/seq/<?=$member['me_seq']?>" onclick="window.open(this.href,'inertMember','width=650,height=820'); return false;"><?=$member['me_name']?></a>
				</td>
