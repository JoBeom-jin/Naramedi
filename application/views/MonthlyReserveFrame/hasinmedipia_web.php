...
<head>
	...
	<style type="text/css">
	body{margin:0; padding-top: 20px; background-color:#334077; width: 100vw; height: max-content;}
	iframe{overflow: hidden;}
	#form-bg{width:100%; height:315px; margin:0 auto; position:relative; text-align: center;}
	...
	#reserv_name{position: absolute; top: 75px; left: 730px}
	#reserv_tel{position: absolute; top: 120px; left: 730px}
	#reserv_email{position: absolute; top: 165px; left: 730px}
	#reserv_hos{position: absolute; top: 75px; left: 1090px}
	#reserv_ques{position: absolute; top: 120px; left: 1090px}
	#reserv_check{position: absolute; top: 160px; left: 1210px}
	#reserv_check1{position: absolute; top: 160px; left: 1227px}
	#reserv_checkText{position: absolute; top: 180px; left: 1280px}
	#reserv_button{position: absolute; top: 10px; left: 1460px}
...
<body>
	...
	<img id="form-img" src="/_resource/landingPage/monthly/text_image.png" alt="">
	<div id="form-bg">
		<form method="post" action="/index.php/Monthlyreserveframe/insertOK" target="formReceiver" style="width: 750px; height: 200px; text-align: center; margin: auto;">
			...
			<div id="reserv_tel">
				...
				<input type="text" id="hu_phone" name="phone" value="" title="연락처" placeholder="전화번호(숫자만입력하세요)"/>
			</div>
			...
			<div id="reserv_button">
				<input type="image" alt="건강검진 접수하기" src="/_resource/landingPage/monthly/button_image.png" class="send-btn"/>
			</div>
