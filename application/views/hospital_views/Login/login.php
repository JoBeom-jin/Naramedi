...
<div id="wrap"> 
	<div id="loging-page">
		...
		<div class="login-form">
			<form method="POST" action="/index.php/rhksflwk?bact=loginOk" target="formReceiver">
				<div class="form-title">
					<p>
						<span class="first">환영합니다.</span>					
						<span class="sub-text">제휴병원 관리자 페이지입니다.</span>
					</p>
					<p class="alert-text">
						※ 크롬 브라우저에 최적화 되었습니다.
					</p>
			...
			<div class="btn-area-center">
				<a href="/index.php/rhksflwk?bact=join">검진기관 신규회원 가입</a>
				&nbsp; | &nbsp;
				<a href="/index.php/rhksflwk?bact=find">비밀번호 찾기</a>
			</div>
