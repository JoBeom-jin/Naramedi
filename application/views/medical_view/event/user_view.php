<div id="event-view">
	...
	<section class="container">
		...
		<div class="row">
			...
			<div class="col-md-3">
				<!-- aside -->
				<aside id="sidebar" class="bg-white" style="position:fixed; width:248px; border:1px solid #cdcdcd; ">
						...
						<figure>
							<form id="item-detail-form" role="form" method="post" action="<?=$menu_url?>/reserve" target="formReceiver">								
								...
								<div style="margin-bottom:10px;">
									<img src="/resource/images/common/event_exp.png" alt="상담 신청" />
								</div>
								<div style="padding: 0px 15px;">
									...
									<div class="form-group">
										<label for="item-detail-memo">남기실 말</label>
										<input type="text" class="form-control framed" id="item-detail-memo" value ="" name="er_memo" placeholder="메모를 남겨주세요.">
									</div>
									...
									<ul class="list-unstyled checkboxes">
										<li>
											<div class="checkbox">
												<label>
													<input type="checkbox" name="accept_one" value="Y" style="margin-left:0px;width: 20px;height: 20px; margin-top: 0px;">&nbsp;<a href="/index.php/medical/contents/etc_personal?win=Y" onclick="window.open(this.href,'accept','height=810px; width=810px;'); return false;" target="_blank" title="새창" >개인정보취급방침 동의(필수)</a>
												</label>
											</div>
										</li>                                  									
									</ul>
									...
									<div class="form-group">
										<button type="submit" class="btn framed3 icon" style="box-shadow:none; background: #fff;">
										<img src="/resource/images/common/talk_event_btn.png" alt="상담 신청하기" />
										</button>
									</div>
								</div>
							</form>				
