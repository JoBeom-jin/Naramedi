<section class="hero-image" style="height: 100px !important;">
	...
	<div class="block2 bg-white" style="border:1px solid #cdcdcd;">
		...
		<div class="tabpanel" id="panel4" role="tabpanel">
			...
			<table class="table table-list" summary="내가 등록한 후기 보기">
				<caption class="hide">후기 목록</caption>
				<thead>
					<tr>						
						<th>기관</th>
						<th>후기 내용</th>
				...
				<tbody>
					...
					<tr>						
						<td>
							<a href="<?=$menu_url?>/modifyReply?seq=<?=$v['ac_seq']?>" onclick="window.open(this.href, 'modifyReplyForm', 'width=400,height=500'); return false;">
								<?=$v['ai_name']?>
							</a>
						</td>
						<td>
