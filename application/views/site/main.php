...
{
	// 연령옵션
	document.getElementById("l-text").innerHTML=v.innerHTML + "<span class='caret'></span>";
	modal2.style.display = "none";
}
function change2(v)
{
	// 지역옵션
	document.getElementById("l-text2").innerHTML=v.innerHTML + "<span class='caret'></span>" ;
	modal3.style.display = "none";
}
function change3(v)
{
	// 테마옵션
	document.getElementById("l-text3").innerHTML=v.innerHTML + "<span class='caret'></span>";
	modal4.style.display = "none";
}
