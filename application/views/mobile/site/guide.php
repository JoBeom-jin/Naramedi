<script type="text/javascript">
	$(document).ready(function(){
		var tabs = $('.nav-tabs li a[data-toggle="tab"]');
...
<section class="container" id="qna">
	<div class="row">
		...
		<div class="col-md-10 bg-white" style="border:1px solid #cdcdcd;">
			...
			<section>
				<div class="row">
					<img src="/resource/images/medical/subpage/callcenter.png">
					...
					<div class="tabbable-panel">
						<div class="tabbable-line" >
							...
							<ul class="nav nav-tabs">
								<li class="active">
									<a href="#tab_default_1" data-toggle="tab"><font size=4>자주하시는 질문 </font></a>
								</li>
								<li>
									<a href="#tab_default_2" <?if($_Auth->isLogin()):?>data-toggle="tab"<?else:?>onclick="alert('1:1온라인 상담은 로그인 회원만 이용하실 수 있습니다.'); return false;"<?endif;?> ><font size=4>1:1 온라인 상담 </font></a>
								</li>
							</ul>
									...
									<section class="faq-form">
										<figure class="clearfix">
											...
											<div class="wrapper">
												...
												<a href="#form-faq" id="faq-btn" class="btn btn-default pull-left" data-toggle="collapse" aria-expanded="false" aria-controls="form-faq" style="margin-top:20px;">온라인 1:1 상담하기</a>
											</div>
										</figure>
										...
										<?else:?>
										<table style="width:100%;" class="articles">
											<thead>
												<tr>
													<th colspan="2"><font size="5">OK건강검진 1:1 상담</font></th>
												</tr>
												<tr>
													<th>제목</th>													
													<th>&nbsp;</th>
