<section class="block4" style="background-image:url(/resource/images/medical/main/main_bg_new.jpg);">
	<div class="container">
		<div class="row" id="main-top-area">
			<div class="col-md-8 col-sm-8" style="padding:0px 3px 0px 0px; height:505px;" >	
				<ul id="image-gallery" class="gallery list-unstyled cS-hidden">
					<?foreach($banner_list as $k => $v):?>
					<li data-thumb="<?=path2url_($v['eb_file_path'])?>"> 
						<?if($v['eb_link']):?>
						<a href="<?=$v['eb_link']?>">
							<img src="<?=path2url_($v['eb_file_path'])?>" width="100%" title="슬라이드 배너 이미지"  width="780px" height="505px"/>
						</a>
						<?else:?>
						<img src="<?=path2url_($v['eb_file_path'])?>" width="100%" title="슬라이드 배너 이미지"  width="780px" height="505px"/>
						<?endif;?>
			...
			<div  id="recommend" class="main-photo-menu col-md-2 col-sm-2" style="padding:0px 3px 0px 0px; margin:0px 0px 0px 0px; width:195px;">
				 <section class="title block5" style="background:#a2a4a3;">
				...
				<div class="list-item">
					...
					<div class="wrapper">
						<div class="image-area">
							<a href="/index.php/medical/contents/hot_hospital/eventList?hi_seq=<?=$hot['hi_seq']?>">
								<img src="<?=path2url_($hot['path'])?>">
							</a>
						</div>
						<div class="info">
							<div class="type">
			...
			<div id="board-notice-artilce" class="main-photo-menu col-md-2 col-sm-2" style="padding:0px 0px 0px 0px; margin:0px 0px 0px 0px; width:195px;"> 
                <section class="title block5" style="background:#a1c1e7;">
				...
				<div class="list-item">
					...
					<div class="wrapper">
						<div class="image-area">
							...
							<a href="/index.php/medical/contents/okmedi_healthboard?act=view&seq=<?=$v['bd_seq']?>"><img src="<?=$v['thum']?>" alt="<?=$v['bd_subject']?>"></a>
							<?endif;?>
						</div>
						<div class="info">
							<div class="type">
								<a href="/index.php/medical/contents/okmedi_healthboard?act=view&seq=<?=$v['bd_seq']?>">
								<span><?=mb_substr($v['bd_subject'], 0, 12)?></span>
								</a>
							</div>
						</div>
					</div>					
			...
			<div class="col-md-4 col-sm-4 search-area" > 
				<form class="subscribe form-inline border-less-inputs" action="<?=$contents_url?>/search_hospital" method="get" role="form">
					<div class="input-group">
						<input type="text" name="ai_name" id="ai_name" placeholder="검진기관명을 입력해주세요">
						<span class="input-group-btn">
							<input type="image" src="/resource/images/medical/main/search_btn.png" alt="검색" />
						</span>
					</div>
				</form>
			</div>
...
<section class="block equal-height">
	<div class="container">
		...
		<style type="text/css">
			...
			#main-event-list .image{height:120px; overflow:hidden;}
				#main-event-list .image img{height:100%;}
			
			#main-event-list .wrapper{padding:10px 15px;}
		</style>
		<div id="main-event-list" class="row">
