<div id="user-join-form">
	<div class="login_banner">
		<img src="/resource/images/mobile/join_us.png" alt="join_us" style="width:100%;">
	</div>

	<section class="container3">
		<div class="block2 bg-white4" >
			<div class="row" style="margin:0px;">
				<div class="col-md-4 col-sm-6 col-md-offset-4 col-sm-offset-3 join-form-area" style="padding:0px 15px; margin-top:0;">
					<header>
						<h2 class="SNS-page-title">SNS 간편 회원 가입</h2>
							<div style="text-align:center;">
							<!-- 네이버,페이스북 회원가입 -->
								<a href=""><img src="/resource/images/mobile/nbt.png" alt="naver_btn" style="width:43vw; margin-right:3px;" ></a>
								<a href=""><img src="/resource/images/mobile/fbt.png" alt="facebook_btn" style="width:43vw; "></a>
							</div>
						<h2 class="page-title" style="padding:20px 0px; font-weight:bold; color:#474747;">회원 가입</h2>
					</header>
					<div style=" width:100%; height:140px;  overflow:hidden; text-align:left; padding:2px;">
					<textarea name id style=" background:#fff;width:100%; height:100%; text-align: left; font-size:10px; resize:none" readonly>
OK검진 서비스 이용약관
...
2.회사는 약관을 변경하는 경우에 회원이 그 변경 여부, 변경된 사항의 시행시기와 변경된 내용을 언제든지 쉽게 알 수 있도록 지속적으로 ‘서비스’ 를 통하여 공개합니다. 이 경우에 변경된 내용은 변경 전과 후를 비교하여 공개합니다.
					...
					<div class="checkbox">
										<!-- <input type="checkbox" name="features1" value="1" id="features1_y" class="runway">&nbsp; -->
										<input type="checkbox" name="features1" value="1" id="" class="">&nbsp;
										<label style="font-size:10px;" ><a href="/index.php/medical/contents/etc_terms?win=Y" onclick="window.open(this.href,'accept','height=810px, width=810px, scrollbars=1'); return false;" target="_blank" title="새창">위 서비스 이용약관에 동의합니다. (필수)</a></label>
									</div>
...
제공되는 개인정보는 이벤트 서비스 이외의 용도로 사용되지 않습니다.
					...
					<div class="checkbox">
									<!-- <input type="checkbox" name="features2" value="2"  style="margin-left:0px;" class="runway">&nbsp; -->
									<input type="checkbox" name="features2" value="2"  style="margin-left:0px;" class="">&nbsp;
									<label style="font-size:10px;"><a href="/index.php/medical/contents/etc_personal?win=Y" onclick="window.open(this.href,'accept','height=810px, width=810px, scrollbars=1'); return false;" target="_blank" title="새창">위 개인정보 취급방침에 동의합니다.(필수)</a></label></div></li>
					...
					<div class="row">	
						<form role="form" id="form-sign-in-account" method="post" action="<?=$menu_url?>/<?=$act?>Ok" target="formReceiver">
							...
							<div class="form-group2 form-group22">
								...
								<div class="form-group2 col-xs-12" >
									<div class="row">
										<div class="col-xs-4">
											...
											<i class="fa fa-angle-down" style="position: absolute; right: 15px; top: 14px;"></i>
										</div>
										<div class="col-xs-4">
							...
							<div class="form-group2 form-group22">
								...
								<div class="form-group6 col-xs-12" >
									<select class="framed" name="md_gender" title="성별선택">
										<option value=""> 성별선택 <span class="caret"></span></option>
										<option value="MAN"> 남성</option>
										<option value="WOMAN"> 여성</option>
									</select>	
									<i class="fa fa-angle-down" style="position: absolute; right: 25px; top: 14px;"></i>					
								</div>
							</div>
								<!-- /.form-group -->
								<div style="clear:both;">&nbsp;</div>
								<!-- <i class="fa fa-angle-right" style="color:#e8a5a5"></i> -->
								<!-- 회원가입 기능 -->
								<div class="form-group7 col-xs-12" style="width:100%; text-align:center;">
									<button type="submit"  style="width:83px; margin-right:10px;" class="btn framed icon">확인</button>
									<button type="cancel"  style="width:83px" class="btn framed2 icon">취소</button>
