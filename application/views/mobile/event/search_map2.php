	...
	<div class="map" id="map-search-area">
				...
				<div class="input-row" style="margin-top:8px;">
					<div class="form-group notauto" style="width:100%;">
						<div class="input-group location" style="text-align:center;">
							<input type="text" class="form-control" name="addr" id="location" placeholder="검색지역 및 검진기관을 입력해주세요." style="ime-mode:auto">
		...
		<div id="map-area">
			<div class="map-btn-area">
				<input type="button" value="검색된 검진기관 보기 > " id="list-btn" onclick="listPage();"/>
			</div>
...
<script type="text/javascript" src="/resource/assets/js/mobile.maps2.js"></script>
...
function setListMenu(x, y){
	var default_url = '/m/index.php/mobile/contents/search2_hospital2/doList?';
	...
	geocoder.geocode(
		...
		function(results, status){
			...
			if(results != ""){
				...
				document.location.href='/m/index.php/mobile/contents/search2_hospital2/index?x='+lat+'&y='+lng;
			}
