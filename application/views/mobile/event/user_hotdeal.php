<div id="hot-deal-list">
	<section class="hero-image">
		<div class="background">
			<img src="/resource/images/mobile/hotdeal_top_image.jpg" alt="핫딜 병원 메뉴 입니다.">
		</div>
	</section>
...
function more_list(){
	...
	$.ajax({
		url: "/index.php/medical/contents/hot_hospital/getListAjax?q_page="+current_page,
		type: "GET",
		dataType: "JSON",
