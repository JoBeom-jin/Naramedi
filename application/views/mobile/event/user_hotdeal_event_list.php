		...
		<div class="">
			...
			<div class="">
							...
							<div class="item">
								<div class="image">
									<a href="<?=$contents_url?>/event_hospital/viewEvent?seq=<?=$v['ei_seq']?>">
										...
										<?if($v['banner']):?>
										<img src="<?=$v['banner']?>" alt="<?=$v['ei_name']?>" style="width:100%; height:auto;">
										<?endif;?>
									</a>
								</div>
				...
				<div class="btn-area-center btn-area-renew">
					<a href="#" id="more-btn" id="more-btn" class="btn btn-default" style="color:white; width:100%;">더보기</a>
				</div>
...
var total_pages = 0;
var more_btn = false;
var ajax_url = '/m/index.php/mobile/contents/hot_hospital/jsonEventList?sort=<?=$sort?>&hi_seq=<?=$hi_seq?>';
...
fbq('track', 'ViewContent', {content_type : 'hot event list',  content_category:'mobile : hot event list'});

fbq('track', 'Lead', {
	content_type: 'hot event list',
	content_category: 'mobile : hot event list',
});	
</script>	