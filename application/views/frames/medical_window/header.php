...
<head>
    ...
    <link href="/resource/assets/fonts/font-awesome.css" rel="stylesheet" type="text/css">
...
<div id="outer-wrapper">
    ...
    <div id="inner-wrapper">
        ...
        <div class="header">
            <div class="wrapper">
                <div class="brand">
                    <img src="/resource/images/medical/common/logo.gif" alt="logo" style="padding:0px 0px 0px 60px ;">
				</div>
            </div>
        </div>
        <!-- end Navigation-->
