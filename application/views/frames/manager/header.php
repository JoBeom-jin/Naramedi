	...
	<div id="wrap">
		...
		<div id="header">
			...
			<div class="session_wrap">
				...
				<div class="btn_wrap">
					<a href="<?=$_site_config['url']['contents']?>/login_loginout" target="formReceiver" class="logout ico"><span class="ico"></span>로그아웃</a>
				</div>
			</div>
		</div>
		<!-- header end --> 
						...
						<li class="menu active">							
							...
							<ul class="depth2" style="display:block;">
								...
								<li class="menu <?if($m2_code == $menu2['menu_code']):?>active<?endif;?>">
									<?if(array_key_exists('url', $m2)):?>
									<a class="link" target="_blank" href="<?=$m2['url']?>" title="새창">
										<?=$m2['title']?>
									</a>																
									<?else:?>
