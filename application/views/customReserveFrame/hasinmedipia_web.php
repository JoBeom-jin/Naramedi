...
<head>
	...
	<style type="text/css">
	body{margin:0; padding:0; background-color:#093864; width: 100vw; height: 100vh;}
	iframe{overflow: hidden;}
	#form-bg{background:url('/_resource/landingPage/reserv_image.png') no-repeat; width:100%; height:315px; margin:0 auto; position:relative; text-align: center;}
	...
	#reserv_name{position: absolute; top: 75px; left: 750px}
	#reserv_tel{position: absolute; top: 130px; left: 750px}
	#reserv_email{position: absolute; top: 175px; left: 750px}
	#reserv_hos{position: absolute; top: 75px; left: 1110px}
	#reserv_ques{position: absolute; top: 130px; left: 1110px}
	#reserv_check{position: absolute; top: 170px; left: 1110px}
	#reserv_check1{position: absolute; top: 170px; left: 1130px}
	#reserv_checkText{position: absolute; top: 190px; left: 1186px}
	#reserv_button{position: absolute; top: 40px; left: 1400px}
	...
	<div id="form-bg">
		<form method="post" action="/index.php/Customreserveframe/insertOK" target="formReceiver" style="width: 750px; height: 200px; text-align: center; margin: auto;">
			...
			<div id="reserv_button">
				<input type="image" alt="건강검진 접수하기" src="/_resource/landingPage/reserv_button.png" class="send-btn"/>
			</div>
			<input type="hidden" name="hu_code" value="nw" />
		</div>
	</form>
</div>
