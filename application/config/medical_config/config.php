...
$_site_config['url']['index'] = $_site_config['url']['root'].'medical/index';
$_site_config['url']['contents'] = $_site_config['url']['root'].'medical/contents';

$_site_config['url']['root_url'] = '/';
$_site_config['url']['resource'] = $_site_config['url']['root_url'].'resource';
$_site_config['url']['images'] = $_site_config['url']['resource'].'/images/medical';
