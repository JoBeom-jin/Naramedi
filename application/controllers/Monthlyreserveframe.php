...
class Monthlyreserveframe extends CI_Controller {
	private $_types = array();
	function __construct(){
		parent::__construct();
		$this->load->model('Hansin/HansinUserModelMonthly', 'userModel');
	...
	public function index(){
		...
		$this->load->view('MonthlyReserveFrame/hasinmedipia_web', $data);
	}

	function acception(){
		$data = false;
		$this->load->view('MonthlyReserveFrame/hasinmedipia_accept', $data);
	}
	...
	function insertOk(){
		...
		if($msg = $this->_checkArgs($args)){
			$data['msg'] = $msg;
			$this->load->view('MonthlyReserveFrame/script', $data);
		}else{
