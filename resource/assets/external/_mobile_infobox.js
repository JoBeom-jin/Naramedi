    ...
    '<div class="infobox ' + color + '">' +
        '<div class="inner">' +
            '<div class="image">' +
                ...
                '<div class="overlay">' +
                    '<div class="wrapper">' +
                        '<a href="/m/index.php/mobile/contents/search_hospital/doView?seq='+data.ai_seq+'" class="quick-view"  id="' + data.ai_seq + '" data-seq="'+data.ai_seq+'">바로가기</a>' +
                        '<hr>' +
                    '</div>' +
                '</div>' +
                '<a href="/m/index.php/mobile/contents/search_hospital/doView?seq='+data.ai_seq+'" class="description quick-view"  id="'+data.ai_seq+'" data-seq="'+data.ai_seq+'">' +
                    '<div class="meta">' +
                        price +
                        '<h2>' + title +  '</h2>' +
                        '<figure>' + location +  '</figure>' +
