...
//  Bootstrap Select ---------------------------------------------------------------------------------------------------
    ...
    bootstrapSelect.live('shown.bs.dropdown', function () {
        dropDownMenu.removeClass('animation-fade-out');
        dropDownMenu.addClass('animation-fade-in');
    });
    bootstrapSelect.live('hide.bs.dropdown', function () {
        dropDownMenu.removeClass('animation-fade-in');
        dropDownMenu.addClass('animation-fade-out');
    });
    bootstrapSelect.live('hidden.bs.dropdown', function () {
        var _this = $(this);
        $(_this).addClass('open');
        setTimeout(function() {
...
//
//		if(  !target && target != '' && !$(this).hasClass("noact") ){
...
//  Timepicker ---------------------------------------------------------------------------------------------------------
    ...
    $('.item .quick-view').live('click',function (e) {
        e.preventDefault();
    });

//  Items scripts ------------------------------------------------------------------------------------------------------

    $('.item.admin-view .hide-item').live('click',function (e) {
...
function setInputsWidth(){
    ...
    for( var i=0; i<$inputRow.length; i++ ){
        if( $inputRow.find( $('button[type="submit"]') ).length ){
            var last = $inputRow.find('.form-group:last')
			if(!last.hasClass('notauto')){
				last.css('width','auto');
			}
        }
    }
...
function rating(element){
    ...
    ratingActive.live('hover',function(){
    ...
    ratingActive.live('click', function(){
...
function drawOwlCarousel(_rtl){
    $.getScript( "/resource/assets/js/owl.carousel.min.js", function( data, textStatus, jqxhr ) {
...
function initializeOwl(_rtl){
    $.getScript( "/resource/assets/js/owl.carousel.min.js", function( data, textStatus, jqxhr ) {
        if ($('.owl-carousel').length > 0) {
            ...
            $('.item-gallery .thumbnails a').live('click', function(){
                $('.item-gallery .thumbnails a').each(function(){
                    $(this).removeClass('active');
                });
                $(this).addClass('active');
            });
            $('.item-slider').live('translated.owl.carousel', function(event) {
